...
(let ((class '((class color) (min-colors 89)))
  ...
  (nord3 (if (display-graphic-p) "#4C566A" "black"))
  (nord4 (if (display-graphic-p) "#D8DEE9" "#D8DEE9"))
  (nord5 (if (display-graphic-p) "#E5E9F0" "white"))
  (nord6 (if (display-graphic-p) "#ECEFF4" "white"))
  (nord7 (if (display-graphic-p) "#8FBCBB" "cyan"))
  (nord8 (if (display-graphic-p) "#88C0D0" "cyan"))
  (nord9 (if (display-graphic-p) "#81A1C1" "blue"))
  (nord10 (if (display-graphic-p) "#5E81AC" "blue"))
  ...
  (nord-annotation (if (display-graphic-p) "#D08770" "yellow"))
  (nord-attribute (if (display-graphic-p) "#8FBCBB" "cyan"))
  (nord-class (if (display-graphic-p) "#8FBCBB" "cyan"))
  (nord-comment (if (display-graphic-p) (nord-theme--brightened-comment-color nord-comment-brightness) "black"))
  (nord-escape (if (display-graphic-p) "#D08770" "yellow"))
  (nord-method (if (display-graphic-p) "#88C0D0" "cyan"))
  ...
  (nord-preprocessor (if (display-graphic-p) "#5E81AC" "blue"))
